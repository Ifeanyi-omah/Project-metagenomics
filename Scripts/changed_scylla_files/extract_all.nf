...
process bgzip_extracted_taxa {
      ...
      output:
          ...
          tuple val(unique_id), path("viral*_and_unclassified_1.f*q.gz"), path("viral*_and_unclassified_2.f*q.gz"), emit: virus_paired, optional:true
...
workflow extract_fractions {
    ...
    main:
        ...
        bgzip_extracted_taxa.out.virus.concat(bgzip_extracted_taxa.out.virus_paired).set{virus}
